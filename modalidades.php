  			...
  			<div class="grid-item">  
				<div class="container" style="margin:40px auto 30px auto;">
						<div class="row">
							...
							<div class="card1">
								<div class="card" style="width: 18rem;">
						  			<img class="card-img-top" src="img/la.png" alt="Card image cap">
						  			<div class="card-body">
						   				<h5 class="card-title">Busca e Resgate</h5>
						   				<<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#ber">Ler Mais</button>
										<div class="modal fade" id="ber" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
										  <div class="modal-dialog">
										    <div class="modal-content">
										      <div class="modal-header">
										        <h5 class="modal-title" id="exampleModalLabel">Busca e Resgate</h5>
						...
						<div class="col">
							<div class="card1">
								<div class="card" style="width: 18rem;">
						  			<img class="card-img-top" src="img/lele.png" alt="Card image cap">
						  			<div class="card-body">
						   				<h5 class="card-title">Sumô</h5>
						    			<p class="card-text"></p>
						...
						<div class="col order-last">
							<div class="card1">				
								<div class="card" style="width: 18rem;">
						  			<img class="card-img-top" src="img/li.png" alt="Card image cap">
						  			<div class="card-body">
